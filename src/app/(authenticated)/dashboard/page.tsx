...
export default function DashboardPage() {
  ...
  const quickStats = useMemo(() => {
    ...
    return [
      ...
      { title: "Pending Payments", value: pendingPaymentsCount, icon: <DollarSign className="h-6 w-6 text-primary" />, color: "text-yellow-500", description: `${currency}${pendingPaymentsAmount.toFixed(2)} due`, href:"/dashboard/job-orders"},
